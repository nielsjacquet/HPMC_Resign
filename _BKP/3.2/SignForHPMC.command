...
sharedResourcesPath="../_SharedResources"
echo $sharedResourcesPath
...
function signHPMC {
  ...
  # ./HPMCEnabler "$toBeSignedFolder/$ogIpa" -inject $dylib -codesign $codesign -p $provisioningProfilePath -j $iosJsPath -n "$ipaName" -v -d "$destinationFolder"
