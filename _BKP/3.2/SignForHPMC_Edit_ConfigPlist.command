...
sharedResourcesPath="$DIR/../_SharedResources/ProvisioningProfile"
...
function provisionCheck {
  ...
  if [[ $amountOfprofiles != 1 ]]
    then
      ...
      provisioningProfilePath="$sharedResourcesPath/$profiledot"
...
function copyConfigPlist {
  ...
  cp -v $configPlist $payloadFolder/$payloadApp
  extractVersion
}
